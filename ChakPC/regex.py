import re
test_doc='''This file contains the actual data for your assignment - good luck!
...
4502 Assistant that is quite helpful and capable of helping
...
8031 that humans are not is why you need to become
skilled at talking computer language.  Once you learn
this new language, you can delegate mundane tasks
to 5933 your 1287 partner 2459 (the computer), leaving more time 
 for you to do the 
...
1108 The advantage of the secondary memory is that it can
...
Input 76 and 8587 Output 9026 Devices are simply our
...
5185 You need to be the person who answers the CPU's What next? 8909
...
We 5034 call 1466 these 4415 stored instructions a program and the act 
...
well-formed 469 sentences 7843 in 2129 this new language.
 8299  2384
...
1531 that you consult www.py4e.com where I have detailed
...
2704 interactive mode 1016

The 9161 >>> 7888 prompt 9753 is the Python interpreter's way of asking you, What
 do you want me to do next?  Python is ready to have a conversation with
9737 you.  All you have to know is how to speak the Python language.

6382 Let's say for example that you did not know even the simplest Python language 8105
...
7675 the conversation is between you and those other 5834
...
7891 in just a few more chapters, you will be one of those
...
8967 of the sentence wrong. 5882

Terminology: interpreter and compiler

Python is a high-level language intended to be relatively
3948 straightforward for humans to read and write and for computers
...
7339 The CPU understands a language we call machine language.  Machine 21
language 3422 is 8049 very 7506 simple and frankly very tiresome to write because it 
 is represented all in zeros and ones.

3317 Machine language seems quite simple on the surface, given that there 
...
2428 and is ready for us to type another line of Python. 2845
...
83 it by seven and put the newly computed value in y.  Then we ask Python to print out 4507
the value currently in y.
8795  4162
Even though we are typing these commands into Python one line at a time, Python
241 is treating them as an ordered sequence of statements with later statements able
...
3233 as shown above.  A compiler needs to be handed the entire program in a file, and then 9932
it 5439 runs 9422 a 8900 process to translate the high-level source code into machine language
...
4517 python, what exactly is happening?
...
8064 sometimes it pays to answer those little nagging questions right at 
the beginning.
...
1598 When we want to write a program, 
...
42
The end'''
my_list=re.findall('[0-9]+',test_doc)
